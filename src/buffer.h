#ifndef __SDR_BUFFER_H__
#define __SDR_BUFFER_H__
...
namespace sdr {
  ...
  class RawBuffer {
    ...
    public:
      ...
      // returns pointer to data of view
      inline char *data() const { return ((char*)_ptr+_offset); }
      // return off set of data by the view
      inline size_t bytesOffset() const { return _offset; }
      // return length of view
      inline size_t bytesLen() const { return _length; }
      // return storage size of buffer
      inline size_t storageSize() const { return _storage_size; }
      // returns True if buffer is empty
      inline bool isEmpty() const { return _ptr == 0; }
